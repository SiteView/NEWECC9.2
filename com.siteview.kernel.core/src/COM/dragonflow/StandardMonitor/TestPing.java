...
public class TestPing extends AtomicMonitor                                                                                                                        
{                                                                                                                                                                     
    ...
    {                                                                                                                                                                 
        ...
        addProperties("COM.dragonflow.StandardMonitor.TestPing", astringproperty);                                                                                 
        addClassElement("COM.dragonflow.StandardMonitor.TestPing", Rule.stringToClassifier("percentGood == 0\terror", true));                                      
        addClassElement("COM.dragonflow.StandardMonitor.TestPing", Rule.stringToClassifier("roundTripTime == n/a\terror"));                                        
        addClassElement("COM.dragonflow.StandardMonitor.TestPing", Rule.stringToClassifier("percentGood < 100\twarning", true));                                   
        addClassElement("COM.dragonflow.StandardMonitor.TestPing", Rule.stringToClassifier("percentGood == 100\tgood", true));                                     
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "description", "Pings a device on the network.");                                              
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "help", "PingMon.htm");                                                                        
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "title", "Ping");                                                                              
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "class", "PingMonitor");                                                                       
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "target", "_hostname");                                                                        
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "toolName", "Ping");                                                                           
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "toolDescription", "Performs a roundtrip test on the network.");                               
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "topazName", "Ping");                                                                          
        setClassProperty("COM.dragonflow.StandardMonitor.TestPing", "topazType", "System Resources");                                                              
    }                                                                                                                                                                 
}                                                                                                                                                                     
